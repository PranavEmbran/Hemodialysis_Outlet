...
export const predialysisFormConfig: FormConfig = {
  ...
  fields: [
    { name: 'PreDR_DS_ID_FK', label: 'Schedule ID', type: 'text', required: true, colSize: 6, disabled: true },
    ...
    { name: 'PreDR_Vitals_BP', label: 'Blood Pressure', type: 'text', required: true, colSize: 6, placeholder: 'e.g. 120/80' },
    { name: 'PreDR_Vitals_HeartRate', label: 'Heart Rate (bpm)', type: 'text', required: true, colSize: 6, placeholder: 'e.g. 72' },
    { name: 'PreDR_Vitals_Temperature', label: 'Temperature (°C)', type: 'text', required: true, colSize: 6, placeholder: 'e.g. 36.5' },
    { name: 'PreDR_Vitals_Weight', label: 'Weight (kg)', type: 'text', required: true, colSize: 6, placeholder: 'e.g. 70' },
    { name: 'PreDR_Notes', label: 'Notes', type: 'textarea', required: false, colSize: 12, placeholder: 'Enter any notes (optional)' },
  ],
  validationSchema: Yup.object({
    PreDR_DS_ID_FK: Yup.string().required('Schedule ID is required'),
  ...
  initialValues: (data: any) => ({
    PreDR_DS_ID_FK: data.PreDR_DS_ID_FK || '',
...
export const startDialysisFormConfig: FormConfig = {
  ...
  validationSchema: Yup.object({
    ...
    SDR_Dialyzer_Type: Yup.string().required('Dialyzer Type is required'),
  ...
  initialValues: (data: any) => ({
    ...
    SDR_Dialyzer_Type: data.SDR_Dialyzer_Type || '',
...
export const postDialysisFormConfig: FormConfig = {
  ...
  fields: [
    { name: 'PostDR_DS_ID_FK', label: 'Schedule ID', type: 'text', required: true, colSize: 6, disabled: true },
    { name: 'patientId', label: 'Patient ID', type: 'text', required: false, colSize: 6, disabled: true },
    { name: 'patientName', label: 'Patient Name', type: 'text', required: false, colSize: 6, disabled: true },
    { name: 'PostDR_Vitals_BP', label: 'Blood Pressure', type: 'text', required: true, colSize: 6, placeholder: 'e.g. 120/80' },
    { name: 'PostDR_Vitals_HeartRate', label: 'Heart Rate (bpm)', type: 'text', required: true, colSize: 6, placeholder: 'e.g. 72' },
    { name: 'PostDR_Vitals_Temperature', label: 'Temperature (°C)', type: 'text', required: true, colSize: 6, placeholder: 'e.g. 36.5' },
    { name: 'PostDR_Vitals_Weight', label: 'Weight (kg)', type: 'text', required: true, colSize: 6, placeholder: 'e.g. 70' },
    { name: 'PostDR_Notes', label: 'Notes', type: 'textarea', required: false, colSize: 12, placeholder: 'Enter any notes (optional)' },
  ],
  validationSchema: Yup.object({
    PostDR_DS_ID_FK: Yup.string().required('Schedule ID is required'),
    patientId: Yup.string(),
    patientName: Yup.string(),
  ...
  initialValues: (data: any) => ({
    PostDR_DS_ID_FK: data.PostDR_DS_ID_FK || '',
    patientId: data.patientId || '',
    patientName: data.patientName || '',
    PostDR_Vitals_BP: data.PostDR_Vitals_BP || '',
    PostDR_Vitals_HeartRate: data.PostDR_Vitals_HeartRate || '',
    PostDR_Vitals_Temperature: data.PostDR_Vitals_Temperature || '',
    PostDR_Vitals_Weight: data.PostDR_Vitals_Weight || '',
