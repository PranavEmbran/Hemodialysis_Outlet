...
export const searchPatients = service.searchPatients;
export const getPatientsPage = service.getPatientsPage;
...
export const addPredialysisRecord = service.addPredialysisRecord;
export const addStartDialysisRecord = service.addStartDialysisRecord;
// export const addInProcessRecord = (service as any).addInProcessRecord;
export const addPostDialysisRecord = service.addPostDialysisRecord;
export const updatePredialysisRecord = service.updatePredialysisRecord;
export const updateStartDialysisRecord = service.updateStartDialysisRecord;
export const updatePostDialysisRecord = service.updatePostDialysisRecord;
...
export const getSessionTimes = service.getSessionTimes;
export const addSessionTime = service.addSessionTime;
export const updateSessionTime = service.updateSessionTime;
export const deleteSessionTime = service.deleteSessionTime;
...
export const updateDialysisScheduleStatus = service.updateDialysisScheduleStatus;
export const checkScheduleConflict = service.checkScheduleConflict;
export const getScheduleWithRelatedRecords = service.getScheduleWithRelatedRecords;
