...
import { getAll, add, deleteById, getPatientsDerivedHandler, searchPatientsHandler, getPatientsPageHandler, getSchedulesAssignedHandler, addSchedulesAssignedHandler, getCaseOpeningsHandler, addCaseOpeningHandler, updateCaseOpeningHandler, savePredialysisRecord, saveStartDialysisRecord, saveInProcessRecord, savePostDialysisRecord, getPredialysisRecords, getStartDialysisRecords, getPostDialysisRecords, updatePredialysisRecord, updateStartDialysisRecord, updatePostDialysisRecord, getUnits, addUnit, updateUnit, deleteUnit, getVascularAccesses, addVascularAccess, updateVascularAccess, deleteVascularAccess, getSessionTimes, addSessionTime, updateSessionTime, deleteSessionTime, updateDialysisScheduleStatus, checkScheduleConflict, getScheduleWithRelatedRecords, getAllSchedulesWithRelatedRecords, getDialyzerTypes, addDialyzerType, updateDialyzerType, deleteDialyzerType, getSchedulingLookup, addSchedulingLookup, updateSchedulingLookup, deleteSchedulingLookup } from '../controllers/dataController.js';
const router = Router();
/**
 * @swagger
 * /api/data:
